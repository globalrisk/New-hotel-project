...
export const defaultRooms: Room[] = [
  ...
  },
  {
    ...
    description: 'Nhà mộc 3 giường — tối đa 3 khách',
  ...
  {
    id: 4,
    name: 'Nhà mộc 6 giường',
    description: 'Nhà mộc 6 giường — tối đa 6 khách',
    weekdayPrice: 3_000_000,
    weekendPrice: 3_500_000,
    amenities: ['WiFi', 'Điều hòa', 'Phòng tắm riêng', 'Không gian rộng cho nhóm'],
    capacity: 6,
  },
];
